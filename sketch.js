...
var ground, invisibleGround, groundImage, desertBackgound, desertBackgoundImg;
...
function preload(){
  ...
  desertBackground = loadImage('desertBackground.png')
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(height/2-20,height-100));
